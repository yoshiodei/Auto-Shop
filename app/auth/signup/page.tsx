...
import { signInWithGoogle } from '@/utils/auth/googleAuth/signInWithGoogle'
    ...
    try {
      ...
      switch (error.code) {
        case "auth/popup-closed-by-user":
            console.error("Sign-in popup was closed.");
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Join AUTO WORLD to buy and sell vehicles</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF6B7A]"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  placeholder="••••••••"
                  className={`w-full pl-10 pr-10 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF6B7A] ${
          ...
          <button
            ...
            disabled={loading}
            className="w-full border border-gray-300 hover:bg-gray-50 disabled:bg-gray-100 text-gray-700 font-semibold py-2 rounded-lg transition-colors flex items-center justify-center gap-2"
          >
          ...
          <p className="text-center mt-6 text-gray-600">
            ...
            <Link href="/auth/signin" className="text-[#FF6B7A] hover:text-[#FF5566] font-semibold">
              Sign In
            </Link>
          </p>
        </div>
