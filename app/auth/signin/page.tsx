    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Sign in to your AUTO WORLD account</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <form onSubmit={handleSignIn} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Link href="/auth/forgot-password" className="text-[#FF6B7A] hover:text-[#FF5566] text-xs font-medium">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center mt-6 text-gray-600">
            ...
            <Link href="/auth/signup" className="text-[#FF6B7A] hover:text-[#FF5566] font-semibold">
              Sign Up
            </Link>
          </p>
        </div>
